...
const getQuery = (queryString) => {
  // TODO: queryString 객체로 변환
  // name=cloudcoke&age=26 => ['name=cloudcoke', 'age=26']
  // => [['name', 'cloudcoke'], ['age', '26']]
  // => {name: 'cloudcoke', age: "26"}
  ...
  // 1. split: [ 'name=cloudcoke', 'age=26' ]
  // 2. map: [ [ 'name', 'cloudcoke' ], [ 'age', '26' ] ]
  // 3. reduce: { name: 'cloudcoke', age: '26' }
};
